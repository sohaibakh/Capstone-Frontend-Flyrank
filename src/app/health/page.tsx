    ...
    <main className="mx-auto max-w-3xl space-y-6 pb-16">
      <section className="rounded-[32px] bg-[#f7f7f7] p-8">
        <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-center">
          ...
          <span className="inline-flex w-fit items-center gap-2 rounded-[100px] bg-white px-4 py-2 text-xs font-semibold text-[#05b169]">
      ...
      <section className="cb-card p-6">
        <div className="mb-5 flex items-center justify-between">
          ...
          <span className="cb-number text-xs text-[#7c828a]">JSON</span>
        </div>
        <pre className="overflow-x-auto rounded-[24px] bg-[#0a0b0d] p-5 text-xs leading-6 text-white">
