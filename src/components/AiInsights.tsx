...
export default function AiInsights({ aiAudit, datasource }: AiInsightsProps) {
  return (
    <section className="animate-rise-in delay-1 rounded-[32px] bg-[#0a0b0d] p-6 text-white sm:p-8">
      <div className="flex flex-col justify-between gap-6 border-b border-white/10 pb-6 md:flex-row md:items-start">
        ...
        <div className="rounded-[24px] bg-[#16181c] p-5">
      ...
      <div className="mt-6 rounded-[24px] bg-white p-5 text-[#0a0b0d]">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-3 text-xs text-[#7c828a]">
...
function InsightCard({ icon: Icon, title, body }: { icon: typeof AuditIcon; title: string; body: string }) {
  return (
    <div className="animate-rise-in rounded-[24px] bg-[#16181c] p-5">
