  ...
  return (
    <footer className="border-t border-[#dee1e6] bg-white">
      <div className="mx-auto max-w-[1200px] px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-[1.2fr_1fr_1fr]">
          <div>
            <Link href="/" className="inline-flex items-center gap-2.5 text-[#0a0b0d]">
              <span className="flex h-9 w-9 items-center justify-center rounded-full bg-[#0052ff] text-sm font-semibold text-white">
                DS
              </span>
          ...
          <div>
            ...
            <nav className="mt-4 flex flex-col gap-3">
              {productLinks.map((link) => (
                <Link key={link.href} href={link.href} className="text-sm text-[#5b616e] hover:text-[#0052ff]">
                  {link.label}
                </Link>
              ))}
            </nav>
          ...
          <div>
            ...
            <div className="mt-4 space-y-3">
              {capabilities.map((item) => {
                ...
                return (
                  <div key={item.label} className="flex items-center gap-3 text-sm text-[#5b616e]">
        ...
        <div className="mt-10 flex flex-col justify-between gap-4 border-t border-[#dee1e6] pt-6 text-xs text-[#7c828a] sm:flex-row sm:items-center">
